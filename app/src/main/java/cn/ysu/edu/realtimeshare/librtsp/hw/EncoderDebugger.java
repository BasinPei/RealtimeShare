...
package cn.ysu.edu.realtimeshare.librtsp.hw;
...
public class EncoderDebugger {
	...
	private cn.ysu.edu.realtimeshare.librtsp.hw.NV21Convertor mNV21;
	...
	/** This {@ librtsp.hw.NV21Convertor} will do the necessary work to feed properly the encoder. */
	public cn.ysu.edu.realtimeshare.librtsp.hw.NV21Convertor getNV21Convertor() {
		return mNV21;
	}
	...
	private void reset() {
		mNV21 = new cn.ysu.edu.realtimeshare.librtsp.hw.NV21Convertor();
	 ...
	 * @param nal If set to true, the NAL will be preceded with 0x00000001.
	 */
