...
package cn.ysu.edu.realtimeshare.httpserver.net;
...
{
	private static final String TAG  = "org.cybergarage.CyberGarage.net.HostInterface";
	// //////////////////////////////////////////////
	// Constants
	// //////////////////////////////////////////////
	...
	public final static int getNHostAddresses()
	{
		...
		{
			Debug.warning(e);
			if(HttpFileServer._listener!=null)
			{
				HttpFileServer._listener.ready("",0);
			}
		}
