...
public final class Debug
{
	...
	{
		if (enabled == true)
			Debug.debug.getOut().println("EasyServer message : " + s);
	}

	public static final void message(String m1, String m2)
	{
		if (enabled == true)
			Debug.debug.getOut().println("EasyServer message : ");
	...
	{
		Debug.debug.getOut().println("EasyServer warning : " + s);
	}
	...
	public static final void warning(String m, Exception e)
	{
		if (e.getMessage() == null)
		{
			Debug.debug.getOut().println(
					"EasyServer warning : " + m + " START");
			e.printStackTrace(Debug.debug.getOut());
			Debug.debug.getOut().println("EasyServer warning : " + m + " END");
		}
		else
		{
			Debug.debug.getOut().println(
					"EasyServer warning : " + m + " (" + e.getMessage() + ")");
			e.printStackTrace(Debug.debug.getOut());
		}
	}
