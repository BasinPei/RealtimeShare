...
package cn.ysu.edu.realtimeshare.librtsp.gl;
 ...
 * libstreaming, call  MediaStream#setStreamingMethod(byte)}
 * with  MediaStream#MODE_MEDIACODEC_API_2}. <br />
 * 
 ...
 * that, call librtsp.gl.SurfaceView#setAspectRatioMode(int)} with
 *  librtsp.gl.SurfaceView#ASPECT_RATIO_PREVIEW} after creating your
 *librtsp.gl.SurfaceView}. <br />
 * 
 */
public class SurfaceView extends android.view.SurfaceView implements Runnable, OnFrameAvailableListener, SurfaceHolder.Callback {
	 ...
	 * the VideoStream} will do it when it's needed.
	 */
