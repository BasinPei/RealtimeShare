...
import cn.ysu.edu.realtimeshare.librtsp.exceptions.ConfNotSupportedException;
import cn.ysu.edu.realtimeshare.librtsp.exceptions.InvalidSurfaceException;
import cn.ysu.edu.realtimeshare.librtsp.exceptions.StorageUnavailableException;
import cn.ysu.edu.realtimeshare.librtsp.gl.SurfaceView;
import cn.ysu.edu.realtimeshare.librtsp.rtsp.RtspClient;
import cn.ysu.edu.realtimeshare.librtsp.video.VideoQuality;
import cn.ysu.edu.realtimeshare.librtsp.video.VideoStream;

/**
 * You should instantiate this class with the {@link librtsp.SessionBuilder}.<br />
 ...
 * (audio samplingrate, video resolution) and then {@link librtsp.Session#getSessionDescription()}.<br />
 *
...
public class Session {
	...
	/**
	 * The destination set with {@link librtsp.Session#setDestination(String)} could not be resolved.
	...
	public interface Callback {
		 ...
		 * after calling {@link librtsp.Session#configure()}.
		 * If an error occurs while configuring the {@link librtsp.Session},
		 * {@link Callback#onSessionError(int, int, Exception)} will be
		 ...
		 * If an error occurs while starting the {@link librtsp.Session},
		 * {@link Callback#onSessionError(int, int, Exception)} will be
	...
	/** You probably don't need to use that directly, use the {@link librtsp.SessionBuilder}. */
	...
	/** Returns the underlying {@link AudioStream} used by the {@link librtsp.Session}. */
	public AudioStream getAudioTrack() {
		return mAudioStream;
	}

	/** Returns the underlying {@link VideoStream} used by the {@link librtsp.Session}. */
	public VideoStream getVideoTrack() {
		return mVideoStream;
	}

	/**
	 * Sets the callback interface that will be called by the {@link librtsp.Session}.
	 ...
	 * Throws exceptions in addition to calling a callback.
	 * @param id The id of the stream to start,0 is AudioStream,1 is VideoStream
	 **/
	 ...
	 * {@link librtsp.Session#getVideoTrack()} and {@link VideoStream#getFlashState()}.
	 **/
