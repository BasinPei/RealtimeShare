 ...
 *	09/02/03
 *		- Giordano Sassaroli <sassarol@cefriel.it>
 *		- Problem : Devices whose description use absolute urls receive wrong CyberGarage.http requests
...
/**
 * HTTPRequest �̳� HTTPPacket ����CyberGarage.http�������Ϣ
 * 
...
{
    private static final String TAG = "org.cybergarage.CyberGarage.http.HTTPRequest";
