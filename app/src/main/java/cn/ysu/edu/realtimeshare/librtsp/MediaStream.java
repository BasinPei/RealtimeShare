...
import cn.ysu.edu.realtimeshare.librtsp.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * 
	 * The {@link #MODE_MEDIACODEC_API_2} mode only concerns {librtsp.video.VideoStream}, it makes
	 ...
	 * { librtsp.video.VideoStream#setVideoQuality(VideoQuality)}
	 * for a { librtsp.video.VideoStream} and { librtsp.audio.AudioStream#setAudioQuality(AudioQuality)}
	 * for a { librtsp.audio.AudioStream}.
	 */
	 ...
	 * This method can only be called after { librtsp.Stream#configure()}.
	 * @throws IllegalStateException Thrown when { librtsp.Stream#configure()} was not called.
	 */
